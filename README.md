1)informacion sobre icochat:
-se le pudo implementar una interferfaz decente 
-se le agrego un login el cual uno se puede registrar con un correo y una contraseña especia y si no cumple con esos daton no se podra ingresar a la ap
